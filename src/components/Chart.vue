<template>
    <div class="flex flex-col gap-4 items-center">
        <div class="relative w-52 h-52 rounded-full bg-gray-100">
            ...
            />
            <div
                class="absolute inset-8 bg-white rounded-full ring-1 ring-slate-500"
            />
            <p
        ...
        <div class="flex gap-8">
            <div class="flex items-center justify-center gap-2">
                <div
                    class="rounded-full w-4 h-4 bg-blue-400 ring-1 ring-slate-500"
                />
                <span>Principle Amount</span>
            </div>
            <div class="rounded-full flex items-center justify-center gap-2">
                <div
                    class="rounded-full w-4 h-4 bg-green-100 ring-1 ring-slate-500"
                />
